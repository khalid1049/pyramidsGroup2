    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            NumberField::new('chair')
                    ->setLabel('<i class="fa-solid fa-chair adding"></i> Chair'),
            NumberField::new('tables')
                    ->setLabel('<i class="fa-solid fa-table adding"></i> Table'),
            NumberField::new('spot')
                    ->setLabel('<i class="fa-solid fa-lightbulb adding"></i> Spot'),
            NumberField::new('wallHanger')
                    ->setLabel('<i class="fa-solid fa-sign-hanging adding"></i> Wall hanger'),
            FieldFormField::addRow(),
            FieldFormField::addColumn('col-lg-6 col-xl-6'),
            NumberField::new('shelf')
                    ->setLabel('<i class="fa-solid fa-layer-group adding"></i> Shelf'),
            NumberField::new('electricPlug')
                    ->setLabel('<i class="fa-solid fa-plug adding"></i> Electric plug'),
            NumberField::new('carpet')
                    ->setLabel('<i class="fa-solid fa-rug adding"></i> Carpet'),
